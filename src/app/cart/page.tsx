  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8">
      ...
      <div className="flex flex-col gap-8 lg:flex-row">
        ...
        {/* Summary */}
        <div className="h-fit w-full rounded-lg border border-gray-200 bg-gray-50 p-4 sm:p-6 lg:w-96">
          ...
          <Button
            className="mt-4 w-full gap-2 text-base py-6 sm:mt-6 sm:text-lg"
            size="lg"
